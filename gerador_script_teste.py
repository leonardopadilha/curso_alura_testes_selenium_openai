...
def gerar_script_teste(cenario_teste, documento, dicionario_arquivos, assistente, thread, modelo=MODELO_GPT_4):
    ...
    pergunta = f""""
        ...
        Considere também inserir quatro (4) casos de teste, utilizando os resultados de {usuarios_teste}. Faça as iterações em um laço de repetição, mostrando ao final "Aprovado" se o teste deveria logar 
        e logou ou deveria falhar e falhou.
